    ...
    <div class="quickview">
      <div class="content">
        <div class="bloc-modale" v-if="revele">
          <div
            class="overlay"
            v-on:click="$emit('toggleModale', concert.id)"
          ></div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 product-left">
                <div class="thumb">
                  <img
                    ...
                    class="card-img-top block-modal__image"
                    alt=""
                  />
                  <h2 class="date">{{ concert.date }}</h2>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12 product-right">
                <div class="infos">
                  <h2 class="title">{{ concert.artiste }}</h2>
                  <div>
                    <button
                      id="button-cartqv"
                      v-on:click="Addto"
                  ...
                  <ul class="blocks">
                    <li class="category_name">
                      <span>TITLE</span><a>{{ concert.title }}</a>
                    </li>
                    <li class="region_name">
                      <span>GENRE</span><a>{{ concert.genre }}</a>
                    </li>
                  </ul>
                  <div class="blocks2">
...
export default {
  name: "ProductModale",
  props: ["revele", "toggleModale", "concert"],
  data() {
    return {
      quantityWanted: 1,
    };
  ...
  methods: {
    ...
    Addto() {
      ...
      console.log(this.concert.artiste);
      var new_wishlist = this.concert.artiste;
      ...
      api
        ...
        .then((response) => {
          ...
          var ID = response.data.data.CurrentUser._id;
          var old_wishlist = response.data.data.CurrentUser.wishlist;
          var addtowishlist = old_wishlist + ", " + new_wishlist;
...
.date {
  ...
  margin-top: 10px;
  font: 400 30px/30px "Racing Sans One", sans-serif;
